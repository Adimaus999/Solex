...
class RemainingWindow(QMainWindow):
    ...
    def update_remaining(self):
        if self.remaining_input is not None:
            try:
                ...
                conn = sqlite3.connect('C:/SOLEX/Solex/2025/Working_Files/Database/SoleX_Database.db')
                cursor = conn.cursor()
                ...
                subprocess.Popen(["powershell", "-NoExit", "-Command", "pthyon C:/SOLEX/Solex/2025/Working_Files/Range_Estimation/Range_Estimation.py"])
    ...
    def SQLread(self, sensor_id, db_path="C:/SOLEX/Solex/2025/Working_Files/Database/SoleX_Database.db", table_name="sensor_data"):
                """
...
class SecondWindow(QMainWindow):
    ...
    def SQLreadmessage(self, sensor_id, db_path="C:/SOLEX/Solex/2025/Working_Files/Database/SoleX_Database.db", table_name="sensor_logs"):
        try:
            conn = sqlite3.connect(db_path)
            cursor = conn.cursor()
            query = f"""
