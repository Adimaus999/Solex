...
def SQLread(sensor_id, db_path="C:/SOLEX/Solex/2025/Working_Files/Database/SoleX_Database.db", table_name="sensor_data"):
    """
...
# Initialise variables    
    ...
    while True:
        ...
        solarDataStructure = pd.concat([solarDataStructure, pd.DataFrame([newSolarZerosRow])], ignore_index=True)
